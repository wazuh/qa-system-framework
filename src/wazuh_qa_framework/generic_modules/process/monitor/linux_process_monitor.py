"""
Module to define a Linux process monitor.

The LinuxProcessMonitor class provides us with an interface of methods that we can use in Linux systems to obtain
information about resources and process information.

This module contains the following:

- LinuxProcessMonitor(ProcessMonitor):
    - get_memory_usage
    - get_memory_usage_percentage
    - get_total_cpu_usage
    - get_num_file_descriptors
    - get_username
    - get_status
    - get_ppid
    - get_creation_time
...
class LinuxProcessMonitor(ProcessMonitor):
