"""
Run a code format analysisd of the input files passed as file list to this script.
...
def run_yaml_linter(yaml_files, config_files_path):
    ...
    if len(bad_yaml_file_name_list) > 0:
        print('Error: The following files have incorrect extension (.yml), please rename them (to .yaml): '
